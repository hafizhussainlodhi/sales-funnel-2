                ...
                <section className="max-w-7xl mx-auto px-6 py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="w-full md:w-[55%] space-y-6 text-left order-2 md:order-1">
                        ...
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-xl font-light">
                            As a result of aging, disease, or lifestyle, your hormone levels will begin to decline. Over time, you will experience unwanted symptoms of hormonal imbalance such as adrenal fatigue, thyroid disorder, male andropause, low testosterone, or progesterone deficiencies — just to name a few. With the help of Bioidentical Hormone Therapy, you will restore your levels back to your youthful years.
                        </p>
